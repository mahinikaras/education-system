  ...
  <div class="col-md-12">
      <div class="card">
           <div class="card-body pdl-40 pdr-40">
              <h4 class="form-header">Course Notes</h4>
              ...
              <div class="col-md-4">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-footer text-center">
                       <a href="{{route('Teacher.Course-details')}}" style="display: block;"> <i class="fa fa-file" aria-hidden="true"></i> Notes</a>
                    </div>
                </div>
              </div>   
              <div class="col-md-4">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-footer text-center">
                       <a href="" style="display: block;"> <i class="fa fa-file" aria-hidden="true"></i> Notes</a>
                    </div>
                </div>
              </div>   
            <div class="col-md-4">
